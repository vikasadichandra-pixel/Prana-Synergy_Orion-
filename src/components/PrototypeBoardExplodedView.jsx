...
export default function PrototypeBoardExplodedView({ scrollProgress = 0 }) {
  ...
  useExplodedParts(PROTO_PARTS_CONFIG, progress, partGroupRefs, lineGroupRefs, linesContainerRef);
