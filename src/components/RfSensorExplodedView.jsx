...
export default function RfSensorExplodedView({ scrollProgress = 0 }) {
  ...
  useExplodedParts(RFSENSOR_PARTS_CONFIG, progress, partGroupRefs, lineGroupRefs, linesContainerRef);
