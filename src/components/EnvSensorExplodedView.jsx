...
export default function EnvSensorExplodedView({ scrollProgress = 0 }) {
  ...
  useExplodedParts(ENV_PARTS_CONFIG, progress, partGroupRefs, lineGroupRefs, linesContainerRef);
