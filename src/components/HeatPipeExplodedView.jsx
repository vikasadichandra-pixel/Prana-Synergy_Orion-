...
export default function HeatPipeExplodedView({ scrollProgress = 0 }) {
  ...
  useExplodedParts(HEATPIPE_PARTS_CONFIG, progress, partGroupRefs, lineGroupRefs, linesContainerRef);
