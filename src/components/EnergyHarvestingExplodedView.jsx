...
export default function EnergyHarvestingExplodedView({ scrollProgress = 0 }) {
  ...
  useExplodedParts(ENERGY_PARTS_CONFIG, progress, partGroupRefs, lineGroupRefs, linesContainerRef);
