...
export default function TempSensorExplodedView({ scrollProgress = 0 }) {
  ...
  useExplodedParts(TEMPSENSOR_PARTS_CONFIG, progress, partGroupRefs, lineGroupRefs, linesContainerRef);
