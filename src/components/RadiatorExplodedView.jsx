...
const RADIATOR_PARTS_CONFIG = layoutExplodedParts([
  {
    id: 'rad_base',
...
export default function RadiatorExplodedView({ scrollProgress = 0 }) {
  ...
  useExplodedParts(RADIATOR_PARTS_CONFIG, progress, partGroupRefs, lineGroupRefs, linesContainerRef);
      ...
      >
        ...
        >
          ...
          <g ref={linesContainerRef} opacity="0" style={{ transition: 'opacity 0.25s' }}>
            {[...RADIATOR_PARTS_CONFIG].reverse().map((part) => {
