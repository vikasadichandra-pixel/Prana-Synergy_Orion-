...
// ——— MAIN COMPONENT ————————————————————————————————————————————
export default function DisplayExplodedView({ scrollProgress = 0 }) {
  ...
  useExplodedParts(DISPLAY_PARTS_CONFIG, progress, partGroupRefs, lineGroupRefs, linesContainerRef);
