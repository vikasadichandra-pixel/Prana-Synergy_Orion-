...
export default function ConverterExplodedView({ scrollProgress = 0 }) {
  ...
  useExplodedParts(CONVERTER_PARTS_CONFIG, progress, partGroupRefs, lineGroupRefs, linesContainerRef);
